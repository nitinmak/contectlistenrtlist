...
Try the ${color_1.input('--lab')} option to see multiple platforms at once.`;
    ...
    async run(inputs, options) {
        ...
        await serve_1.serve({ flags: this.env.flags, config: this.env.config, log: this.env.log, prompt: this.env.prompt, shell: this.env.shell, project: this.project }, inputs, options);
